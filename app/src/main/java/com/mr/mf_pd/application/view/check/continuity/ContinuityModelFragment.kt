...
class ContinuityModelFragment : BaseCheckFragment<ContinuityDataBinding>() {
    ...
    var continuityMaxValue1: Int = 20
    var continuityMaxValue2: Int = 20
    var continuityMaxValue3: Int = 5
    var continuityMaxValue4: Int = 5
    ...
    override fun onYcDataChange(bytes: ByteArray) {
        ...
        if (valueList.size >= 4) {
            view?.let {
                ...
                continuityMaxValue1 =
                    calculationProgress(progressBar1, yxValue, continuityMaxValue1)
                continuityMaxValue2 =
                    calculationProgress(progressBar2, fzValue, continuityMaxValue2)
                continuityMaxValue3 = calculationProgress(progressBar3, f1Hz, continuityMaxValue3)
                continuityMaxValue4 = calculationProgress(progressBar4, f2Hz, continuityMaxValue4)
